...
description: Plataforma de colaboración segura con arquitectura Zero Trust basada en OpenZiti, Zrok y Keycloak
---
...
Arquitectura de confianza cero que expone aplicaciones legacy e internas de forma segura mediante **OpenZiti** (overlay network), **Zrok** (ingress sin VPN) y **Keycloak** (autenticación OIDC), sin necesidad de agentes o plugins en el cliente.
...
→ [Ver tech stack](/es/idcolab/tech-stack)
:::

::: info 🚀 Plan de Implementación
Fases y tareas del proyecto Zero Trust.
→ [Ver plan](/es/idcolab/implementation-plan)
:::

::: info 🔄 Guía de Arranque
Inicio rápido y troubleshooting diario.
→ [Ver restart guide](/es/idcolab/restart-guide)
:::

::: info 📋 Reglas de Trabajo
Reglas de oro y estándares de despliegue.
→ [Ver reglas](/es/idcolab/work-rules)
:::

::: info 📦 Angular Schematic
Documentación técnica del generador tb-front-base.
→ [Ver entregable](/es/idcolab/deliverables/angular-schematic)
:::

::: info 🔑 API Toolbox Keycloak
Documentación técnica de keycloak-api-sys.
→ [Ver entregable](/es/idcolab/deliverables/keycloak-api)
:::
