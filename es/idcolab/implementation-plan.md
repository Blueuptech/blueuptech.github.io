...
Arquitectura de confianza cero (Zero Trust) donde el acceso al Frontend y Backend está mediado nativamente por la integración del SDK de OpenZiti `@openziti/ziti-sdk-browser` directamente en la aplicación Angular, conectándose a una red Overlay sin necesidad de plugins de navegador externos.
