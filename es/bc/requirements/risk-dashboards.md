...
description: Requisitos funcionales del módulo de dashboards de riesgo
---
...
::: info Stitch MCP
El componente de data grid y sus layouts específicos **DEBEN** ser construidos usando el Stitch MCP para asegurar alineación con los estándares de plataforma.
:::
...
## 4. Mapeo de Arquitectura de Datos
