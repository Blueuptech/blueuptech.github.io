...
4. **Documentation en español**: Todas las explicaciones, comentarios de código y documentación deben generarse en español
...
### 1. Architecture del Dockerfile (Estrategia de Producción)
