...
description: Functional Requirements del módulo de gestión de políticas
---
...
::: info Stitch MCP
La interfaz del editor de reglas y las vistas de aprobación manual **MUST** ser generadas usando el Stitch MCP.
:::
...
## 4. Mapeo de Architecture de Enforcement de Políticas
