...
description: Functional Requirements de la interfaz global y navegación de la plataforma AML
---
...
::: info Generation via Stitch MCP
All designs, layouts and components **MUST** ser creados usando el Stitch MCP. Los diseños generados deben adherirse estrictamente a los estándares definidos en la plataforma Stitch y mantener una estética "Corporate Enterprise" (azules apagados, grises, alto contraste).
:::
...
## 4. Mapeo de Architecture de Identidad & Auth
